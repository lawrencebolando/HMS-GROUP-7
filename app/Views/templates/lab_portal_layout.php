...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gradient-to-b from-blue-900 to-blue-800 text-white">
            <div class="p-6">
                <h1 class="text-2xl font-bold">Lab Portal</h1>
            </div>
            <nav class="p-4">
                <ul class="space-y-2">
                    <li>
                        <a href="<?= base_url('lab/dashboard') ?>" class="flex items-center px-4 py-3 nav-item <?= strpos($currentPath, 'lab/dashboard') !== false ? 'nav-active' : '' ?> rounded-lg">
