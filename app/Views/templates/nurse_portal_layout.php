...
<head>
    ...
    <title><?= $title ?? 'Nurse Portal' ?></title>
...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-gradient-to-b from-blue-900 to-blue-800 text-white">
            <div class="p-6">
                <h1 class="text-2xl font-bold">Nurse Portal</h1>
            </div>
            <nav class="p-4">
                <ul class="space-y-2">
                    <li>
                        <a href="<?= base_url('nurse/dashboard') ?>" class="flex items-center px-4 py-3 nav-item <?= strpos($currentPath, 'nurse/dashboard') !== false ? 'nav-active' : '' ?> rounded-lg">
